...
|--------|-------------|--------|
| `workflows` | Developer workflow automation — create agents, ship git changes, implement + test features per stack | `create-agent`, `git-ship`, `coding-principles`, `react-dev`, `dotnet-dev` |
