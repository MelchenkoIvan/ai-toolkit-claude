...
| Plugin | Purpose |
|--------|---------|
| `workflows` | Developer automation: create agents, ship git changes (branch/commit/push/PR), implement + test + review features per stack (React/.NET skills + developer/tester/reviewer agents) |
